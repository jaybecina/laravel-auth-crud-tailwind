                ...
                <div class="p-6 text-gray-900 mb-4">
                    ...
                    <form method="POST" action="{{ route('product.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="qty" class="block my-1 w-full" type="number" name="qty" :value="old('qty')" required autocomplete="off" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="price" class="block my-1 w-full" type="text" name="price" :value="old('price')" required autofocus autocomplete="off" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="description" class="block my-1 w-full" type="text" name="description" :value="old('description')" required autofocus autocomplete="off" />
